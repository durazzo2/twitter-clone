...
export default function InfiniteFeed({ initialPosts, currentUserId }: any) {
    ...
    return (
        <div className="divide-y divide-gray-200 dark:divide-gray-800 w-full overflow-hidden">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between gap-2">
                                <div className="flex items-center gap-1 min-w-0 overflow-hidden">
                                    <Link href={`/${post.author?.username}`} className="font-bold text-[17px] hover:underline truncate">
            ...
            {hasMore && <div ref={ref} className="p-8 text-center text-gray-500">{isLoading ? "Loading more..." : ""}</div>}
